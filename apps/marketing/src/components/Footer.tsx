...
const COLS = [
  {
    ...
    links: [
      ...
      { label: 'Dashboard', href: `${WEB_APP}/dashboard` },
      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mb-14">
          ...
          <div className="md:col-span-1">
            <FooterLogo />
            <p className="text-sm mt-4 leading-relaxed text-gray-500 max-w-xs">
              The no-code widget platform for modern websites. Free forever plan available.
            </p>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-600">
          <span>© 2025 Devixus. All rights reserved.</span>
