...
export const widgets: WidgetInfo[] = [
  ...
  },
  {
    ...
    slug: 'instagram-feed',
    name: 'Instagram Feed',
    description: 'Display your Instagram posts on any website. Auto-updates when you post.',
    longDescription: 'Embed your Instagram feed directly on your website with a beautiful grid, carousel, or masonry layout. Fully customizable — control columns, captions, likes display, and more.',
    category: 'Social Media',
    color: '#E1306C',
    bgColor: '#fce7f3',
    features: [
      'Grid, carousel, and masonry layouts',
      'Show likes and comments on hover',
      'Video play icon support',
      'Configurable columns and gap',
      'Light and dark theme',
      'Link to Instagram on click',
    ],
    useCases: [
      'Photographers to showcase their work',
      'Brands to embed social content',
      'Influencers to drive Instagram follows',
      'Restaurants to show food photography',
    ],
    available: true,
  },
  {
    ...
    slug: 'tiktok-feed',
    name: 'TikTok Feed',
    description: 'Embed your TikTok videos on any website. Fully customizable grid or carousel.',
    longDescription: 'Show your latest TikTok videos on your website with portrait-ratio thumbnails, view counts, and like counts. Supports grid, carousel, and list layouts.',
    category: 'Social Media',
    color: '#010101',
    bgColor: '#f3f4f6',
    features: [
      'Grid, carousel, and list layouts',
      'Portrait ratio (9:16) thumbnails',
      'View count and like count display',
      'Duration badge on each video',
      'Formatted numbers (125K, 1.2M)',
      'Light and dark theme',
    ],
    useCases: [
      'Content creators to showcase videos',
      'Brands to embed TikTok campaigns',
      'Influencers to grow TikTok following',
      'Marketing agencies for social proof',
    ],
    available: true,
  },
]
